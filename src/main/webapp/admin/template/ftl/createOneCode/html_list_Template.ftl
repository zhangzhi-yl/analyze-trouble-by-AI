						...
						<div class="row">
							<div class="col-xl-12">
								...
								<div class="card-block table-border-style" style="margin-top: 10px">
									<el-table :key="tableKey" :data="varList" v-loading.body="loading" size="small"
											  stripe max-height="600" border highlight-current-row style="width: 100%">
										...
										<el-table-column fixed="right" width="300px" align="center" label="操作">
											<template slot-scope="scope">
									...
									<div class="page">
										<div v-show="!loading" class="pagination-container">
											<el-pagination style="float: right;padding-top: 10px;margin-top: 0px;"
														   @size-change="changeCount" @current-change="toTZ" :current-page="1"
