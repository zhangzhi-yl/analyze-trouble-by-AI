...
<body>
<div class="col-xl-12" style="padding-top: 15px;" id="app" v-loading.fullscreen.lock="loading">
	<template>
										...
										<div style="padding-left: 20px;padding-top: 15px;">
											<el-row>
												...
												<el-col :span="6" style="padding-top: 3px;">
													...
													<el-button v-show="add" class="filter-item" type="success"
											...
											<div class="page">
												<div v-show="!loading" class="pagination-container">
													<el-pagination
															...
															:total="page.totalResult" </el-pagination>
												</div>
											</div>
										</div>
									</div>
