							...
							<div style="width: 100%;padding-top:20px">
												...
												<el-row>
													<el-col :span="22">
														<el-form-item label="${var[2]}">
															<el-date-picker disabled v-model="pd.${var[0]}" size="small"
								...
								<div class="input-group" style="margin-top:10px;display:flex;justify-content:center">
                                        <span style="width: 100%;text-align: center;">
                                            <el-button onclick="top.Dialog.close()" size="small">关闭</el-button>
                                        </span>
								</div>
							</div>
