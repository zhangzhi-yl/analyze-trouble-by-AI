...
public class SendWeChatMessage {
    ...
    // 获取配置文件中的值
    private final static String CORPID = "ww3b0a55ccb539f60f";// 需要自己申请，官网有试用企业号
   // private final static String CORPID = "wxfb8de739cb407bb3";// 需要自己申请，官网有试用企业号
    // 可以申请试用
    private final static String CORPSECRET = "ydrvrr4GkBFpcDiZ4Sc7bBi3azv2W3qhwfjmVeIPdlI";
   // private final static String CORPSECRET = "X7JXK7W6sS3hHoHm2GO89HPRPGZJC3m5lG3kSRBEflBem8VCv99cOK99KeNhEYh9";
    // 获取访问权限码URL
    ...
    public String getAccessToken() throws Exception {
    	...
    	pd=brdbService.findWXById();
    	long hmDQ=System.currentTimeMillis(); 
		String tok1=pd.getString("TOKVALUE");
		String tok2=pd.getString("TIMES");
		long hmOld=Long.parseLong(tok2);
        ...
        String result = "";
		  ...
		  try {
	        ...
	        post.releaseConnection();
	        pd.put("TOKVALUE",result);
			pd.put("TIMES",""+hmDQ);
			brdbService.editWX(pd);
		  }else{
		  result=tok1;
	  }
        return result;
