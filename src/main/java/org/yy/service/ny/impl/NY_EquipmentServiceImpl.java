...
import org.yy.mapper.dsno1.ny.NY_EquipmentMapper;
...
@Service
@Transactional //开启事物
public class NY_EquipmentServiceImpl implements NY_EquipmentsService {

	@Autowired
	private NY_EquipmentMapper equipmentMapper;
	...
	public List<PageData> findByName(PageData pd) throws Exception {
		return equipmentMapper.findByName(pd);
	}
