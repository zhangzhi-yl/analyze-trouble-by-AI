...
import org.yy.service.wglwt.QuestionbankenclosureService;
 ...
 */
@Controller
@RequestMapping("/questionbankenclosure")
public class QuestionbankenclosureController extends BaseController {
	
	@Autowired
	private QuestionbankenclosureService questionbankenclosureService;
	...
	public Object adds() throws Exception{
		...
		pd = this.getPageData();
		pd.put("QUESTIONBANKENCLOSURE_ID", this.get32UUID());	//主键
		questionbankenclosureService.save(pd);
	...
	public void downExcel(HttpServletResponse response)throws Exception{
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = questionbankenclosureService.findById(pd);	//根据ID读取
	...
	public Object delete() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		questionbankenclosureService.delete(pd);
	...
	public Object edit() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		questionbankenclosureService.edit(pd);
		map.put("result", errInfo);
		return map;
	}
	...
	public Object list(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = questionbankenclosureService.list(page);	//列出Questionbankenclosure列表
	...
	public Object add(@RequestParam(value = "FFILEPATH", required = false) MultipartFile FFILEPATH) throws Exception{
		...
		pd.put("QUESTIONBANKENCLOSURE_ID",this.get32UUID());
	...
	public Object deleteAll() throws Exception{
		...
		if(Tools.notEmpty(DATA_IDS)){
			...
			questionbankenclosureService.deleteAll(ArrayDATA_IDS);
			errInfo = "success";
		}else{
			errInfo = "error";
		}
	...
	public ModelAndView exportExcel() throws Exception{
		...
		List<PageData> varOList = questionbankenclosureService.listAll(pd);
