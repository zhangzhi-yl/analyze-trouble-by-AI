 ...
 */
@Controller
@RequestMapping("/looptime")
public class LoopTimeController extends BaseController {
...
//	@RequiresPermissions("looptime:add")
	@ResponseBody
	public Object add() throws Exception{
		...
		pd = this.getPageData();
		String loopid = pd.getString("Loop_ID");
		if(null != loopid && !"".equals(loopid)){
			pd.put("LOOPTIME_ID", this.get32UUID());	//主键
			pd.put("Creator", Jurisdiction.getName());
			pd.put("CreateTime",Tools.date2Str(new Date(),"yyyy-MM-dd HH:mm:ss"));
			looptimeService.save(pd);
		}else {
			errInfo = "主表ID丢失";
		}
...
//	@RequiresPermissions("looptime:del")
	@ResponseBody
...
//	@RequiresPermissions("looptime:edit")
	@ResponseBody
...
//	@RequiresPermissions("looptime:list")
	@ResponseBody
	public Object list(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = looptimeService.list(page);	//列出LoopTime列表
...
//	@RequiresPermissions("looptime:edit")
	...
	public Object goEdit() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = looptimeService.findById(pd);	//根据ID读取
		map.put("pd", pd);
		map.put("result", errInfo);
		return map;
	}	
...
//	@RequiresPermissions("looptime:del")
	...
	public Object deleteAll() throws Exception{
		...
		if(Tools.notEmpty(DATA_IDS)){
			...
			looptimeService.deleteAll(ArrayDATA_IDS);
			errInfo = "success";
		}else{
			errInfo = "error";
		}
...
//	@RequiresPermissions("toExcel")
	public ModelAndView exportExcel() throws Exception{
		...
		List<PageData> varOList = looptimeService.listAll(pd);
