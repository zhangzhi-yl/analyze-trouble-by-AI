 ...
 */
@Controller
@RequestMapping("/questionbankenclosures")
public class QuestionbankenclosuresController extends BaseController {
	
	@Autowired
	private QuestionbankenclosuresService questionbankenclosuresService;
	...
	public Object add() throws Exception{
		...
		questionbankenclosuresService.save(pd);
	...
	public Object delete() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		questionbankenclosuresService.delete(pd);
	...
	public Object edit() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		questionbankenclosuresService.edit(pd);
		map.put("result", errInfo);
		return map;
	}
	...
	public Object list(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = questionbankenclosuresService.list(page);	//列出Questionbankenclosures列表
	...
	public Object goEdit() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = questionbankenclosuresService.findById(pd);	//根据ID读取
		map.put("pd", pd);
		map.put("result", errInfo);
		return map;
	}	
	...
	public Object deleteAll() throws Exception{
		...
		if(Tools.notEmpty(DATA_IDS)){
			...
			questionbankenclosuresService.deleteAll(ArrayDATA_IDS);
			errInfo = "success";
		}else{
			errInfo = "error";
		}
	...
	public Object add(@RequestParam(value = "FFILEPATH", required = false) MultipartFile FFILEPATH) throws Exception{
		...
		System.out.println(pd.get("PATH").toString());
	...
	public ModelAndView exportExcel() throws Exception{
		...
		List<PageData> varOList = questionbankenclosuresService.listAll(pd);
