...
@Controller
public class GetWillOverdueCabinetListQuartz extends BaseController implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		List<PageData> willOverdueCabinetList = earlyWarningService.getWillOverdueCabinetList(pd);
		for (PageData pageData : willOverdueCabinetList) {
			...
			pdNotice.put("FContent",
					"柜体号" + pageData.getString("柜体号") + "的柜体即将超期" + pageData.get("超期天数").toString() + "天了，请注意");
