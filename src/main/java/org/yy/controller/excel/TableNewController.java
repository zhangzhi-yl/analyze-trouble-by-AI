...
import org.yy.service.excel.ExcelNewService;
...
@Controller
@RequestMapping("/excelonlinenew")
public class TableNewController extends BaseController {

	@Autowired
	private ExcelNewService excelService;
