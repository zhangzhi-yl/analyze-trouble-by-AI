...
import org.yy.controller.act.util.BpmsActivityTypeEnum;
import org.yy.controller.act.util.UtilMisc;
...
public class AcBusinessController extends BaseController {
	...
	protected List<Task> findMyTaskList(String proId){
		List<Task> tasklist = taskService.createTaskQuery().processInstanceId(proId).list();
		return tasklist; 
	}
	/**查询我的任务
	 * @param USERNAME
