package org.yy.plugins.websocketOnline;
...
public class OnlineChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		}else if(null != message && message.startsWith("[QQ356703572]")){
			OnlineChatServerPool.setYysystem(conn);
			this.getUserList();
		}else{
	...
	public void getUserList(){
		WebSocket conn =  OnlineChatServerPool.getYysystem();
		if(null == conn){return;}
		JSONObject result = new JSONObject();
	 ...
	 * @param conn
	 */
	public void addUserToYysystem(String user){
		WebSocket conn =  OnlineChatServerPool.getYysystem();
		if(null == conn){return;}
		JSONObject result = new JSONObject();
